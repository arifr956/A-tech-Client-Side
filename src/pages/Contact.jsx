...
const Contact = () => {
    return (
        <div>
            <h3 className="text-3xl font-bold text-center my-5 underline decoration-sky-500">Contact Us</h3>
            <div className="flex justify-center items-center w-screen my-5 h-screen bg-white">
                  ...
                  focus:outline-none focus:shadow-outline">
                    ...
                    <div
                        ...
                        <div className="flex flex-col text-white">
                            ...
                            <p className="text-gray-400">Send us your valueable opinions & help us to grow up.
                            </p>
                            ...
                            <div className="flex my-4 w-2/3 lg:w-1/2">
                                ...
                                <div className="flex flex-col">
                                    ...
                                    <p className="text-gray-400">59, West Rajabazar Dhaka</p>
                                </div>
                            </div>
